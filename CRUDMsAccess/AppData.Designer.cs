...
namespace CRUDMsAccess {
    ...
    public partial class AppData : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeesRow AddEmployeesRow(string NamaBarang, string Jumlah, string Harga, byte[] Image) {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Employees` WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `NamaBarang` IS" +
                " NULL) OR (`NamaBarang` = ?)) AND ((? = 1 AND `Jumlah` IS NULL) OR (`Jumlah` = ?" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employees` (`NamaBarang`, `Jumlah`, `Harga`, `Image`) VALUES (?, ?, " +
                "?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Employees` SET `NamaBarang` = ?, `Jumlah` = ?, `Harga` = ?, `Image` = ? WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `NamaBarang` IS NULL) OR (`NamaBarang` = ?)) AND ((? = 1 AND `Jumlah` IS NULL) OR (`Jumlah` = ?)) AND ((? = 1 AND `Harga` IS NULL) OR (`Harga` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, NamaBarang, Jumlah, Harga, [Image] FROM Employees";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_NamaBarang, string Original_Jumlah, string Original_Harga) {
        ...
        public virtual int Insert(string NamaBarang, string Jumlah, string Harga, byte[] Image) {
            if ((NamaBarang == null)) {
        ...
        public virtual int Update(string NamaBarang, string Jumlah, string Harga, byte[] Image, int Original_EmployeeID, string Original_NamaBarang, string Original_Jumlah, string Original_Harga) {
            if ((NamaBarang == null)) {
