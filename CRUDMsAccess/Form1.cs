...
namespace CRUDMsAccess
{
    public partial class Form1 : Form
    {
            ...
            if (e.KeyChar == (char)13)
            {
                ...
                else
                {
                    var query = from o in this.appData.Employees
                                where o.NamaBarang.Contains(txtSearch.Text) || o.Jumlah == txtSearch.Text || o.Harga == txtSearch.Text
                                select o;
        ...
        private void dataGridView_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Are you sure want to delete this record ?", "Massege", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
